                ...
                if vehicle == "Jason":
                    try:
                        ...
                        loweringOBJ = {
                            ...
                            'lowering_hidden': lowering['lowering_hidden'],
                            'lowering_access_list': [],
                            'lowering_additional_meta': {
                                'lowering_description': lowering['lowering_description'],
                                'lowering_files': []
                            }
                        }
                    ...
                    try:
                        ...
                        loweringOBJ = {
                            ...
                            'lowering_additional_meta': {
                                'lowering_description': lowering['lowering_description'],
                                'lowering_pilot': lowering['lowering_pilot'],
                                'lowering_observers': lowering['lowering_observers'],
                                'lowering_files': []
                            }
                        }
                        return_lowerings.append(loweringOBJ)
