...
if __name__ == '__main__':
    ...
    new_copyScript = modifyCopyScript(args.loweringID, args.framegrabCopyScript, args.vehicle)

    if(new_copyScript):
        print("#!/bin/bash")
        print("SOURCE_DIR=../framegrabs")
        print("DEST_DIR=" + imageBaseDir[args.vehicle])
        for dirname in newImageSources:
            print('mkdir -p ${DEST_DIR}/' + args.loweringID + '/' + dirname)
