...
const {
  emailAddress, emailPassword, reCaptchaSecret, resetPasswordURL
      ...
      async handler(request, h) {
        ...
        try {
          ...
          mailOptions = {
            ...
            html: '<p>New user: ' + user.username + ' ( ' + user.fullname + ' ) has just registered an account with Sealog. Please ensure this user\'s access permissions have been configured correctly.</p>'
          };
    ...
    server.route({
      ...
      config: {
        ...
        notes: 'Use this method to obtain a JWT based on the provided username/password.\
          To prevent BOT abuse this call also requires a reCaptcha hash key',
        tags: ['login', 'auth', 'api']
      }
    });
